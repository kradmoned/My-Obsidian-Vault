...
Flow of process is one after another like water going down. If we see the slide , we will see it cascading down.
Imagine you are a fish and you are to develop a project. You are at a stage. you finish the current stage. You will go through each step not skipping one.
Similarly if we have to go to back a few steps lets say because customer added some new requirement. Just like a fish , it will be impossible for you to go back the waterfall. Just like 
How a fish cant go back stream. So if we go in the direction of waterfall. its easy and not hard. but if we have to go backward its so hard.
### The good thing
...
1.  #### System Engineering
	1. Understand as a system.
	2.  We will make a system, like make an outline. See what things we want to make.
	3.  High level Architectural Analysis
2. #### Requirement Analysis
	...
	2. Functional Specification
		...
		- List of functional
		- Such as print id card function.'
			- non functionality is like how good the function is like print 7 id card in a4 page.
		- The objective of the functin must be measurable.
			- Like you cant say that printing should be good.
	3. Acceptance Test Specification
		1. What will be the criteria under which this project will be evaluated or accepted.
			1. Like a user should be able to login.
		2. Like we will only give these things to u in a project
3. #### Design
4. #### Construction
5. #### Testing
6. #### Installation
